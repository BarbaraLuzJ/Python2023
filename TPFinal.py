                            ...
                            if opcionTres=="1":
                                ...
                                for producto in productos:
                                    ...
                                    if producto["Origen"].casefold() == pais.casefold():
                                        cant+=1
                                        print(f"║ {producto['Nombre'].casefold():<29}│ {producto['Codigo']:<10}│ {producto['Categoria']:<24}│ {producto['Stock']:<10}│ {producto['Origen'].casefold():<31}║")
                                print('╚', end='')
                                print('═'*113, end='')
                                print('╝')
                                print('')      
                                ...
                                for producto in productos:
                                    if producto["Origen"].casefold() != "Argentina".casefold():
                                        cant+=1
                                        print(f"║ {producto['Nombre'].casefold():<29}│ {producto['Codigo']:<10}│ {producto['Categoria'].casefold():<24}│ {producto['Stock']:<10}│ {producto['Origen'].casefold():<31}║")
                                print('╚', end='')
                                print('═'*113, end='')
                                print('╝')
                                print('')      
                                ...
                                for producto in productos:
                                    m.decorar(f"Hay {producto['Stock']} unidades en stock de {producto['Nombre'].upper()}")
                                continue
